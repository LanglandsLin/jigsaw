...
class Processor():
    ...
    def load_model(self):
        self.model = O3N(self.args.model_type, self.args.num_video, self.args.num_label)
    ...
    def train(self):
        ...
        for data, label in loader:
            ...
            #print(pre)
            #print(label)
            tmp_acc = pre.eq(label.view_as(pre)).sum().item() / label.shape[0]
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--num_video', type=int, default=9, help='num_video')
        parser.add_argument('--num_label', type=int, default=100, help='num_label')
        ...
        parser.add_argument('--save_output', default='self_supervised/stdout_9_100', help='save_output')
        parser.add_argument('--save_weights', default='self_supervised/epoch{}_model_9_100.pt', help='save_weights')
        parser.add_argument('--start_epoch', type=int, default=0, help='start training from which epoch')
        parser.add_argument('--num_epoch', type=int, default=500, help='stop training in which epoch')
        parser.add_argument('--gpus', type=list, default=[2, 3], help='the indexes of GPUs for training or testing')
